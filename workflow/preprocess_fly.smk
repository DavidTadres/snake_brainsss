...
########################################################
fly_folder_to_process = 'nsybGal4_x_mCardinal/fly_001' # folder to be processed
...
rule motion_correction_parallel_processing_rule:
    ...
    resources:
        mem_mb='100Gb'#=snake_utils.mb_for_moco_input, #.mem_mb_much_more_times_input,
...
rule zscore_rule:
    ...
    input:
        ...
        path_ch3 = str(fly_folder_to_process_oak) + "/{zscore_imaging_paths}/moco/channel_3_moco.nii" if 'channel_3' in FUNCTIONAL_CHANNELS else[],
