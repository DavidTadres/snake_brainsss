...
path = pathlib.Path('/Volumes/groups/trc/data/Brezovec/2P_Imaging/20190101_walking_dataset/fly_308/')
...
warps_ZPOS = warp_STA_brain(STA_brain=STA_brain, fly='fly_308',fixed=fixed, anat_to_mean_type='myr')
