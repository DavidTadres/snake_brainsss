...
To build a fly, i.e. in '/oak/stanford/groups/trc/data/David/Bruker/imports/20240326' 

type:
`snakemake --profile profiles/simple_slurm -s build_fly.smk --directory /oak/stanf
